...
pub fn execute_rv_command(command: &str, test_dir: &Path, config_path: &Path) -> Result<(String, String)> {
...
pub fn parse_r_step_outputs(full_output: &str, step_names: &[String]) -> std::collections::HashMap<String, String> {
