...
pub use dependency_edit::{
    AddOptions, add_packages, is_http_url, looks_like_git_http_url, parse_add_package_spec,
    read_and_verify_config, remove_packages, resolve_add_options_reference_with_executor,
};
