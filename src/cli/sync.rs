...
use crate::{Lockfile, SyncChange, SyncHandler, system_req, timeit, Resolution};
...
impl SyncHelper {
    pub fn run<'a>(&self, context: &'a CliContext, resolve_mode: ResolveMode) -> Result<Resolution<'a>> {
